...
// in simulator we redefine to format for tableViewTest Developer console
...
{\
	NSString * exceptionName = [@"org.tableviewtest." stringByAppendingString:NSStringFromClass([self class])];\
...
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.tableviewtest";\
	NSString * message = [NSString stringWithFormat:@"%@. %@ %@",reason,(subreason!=nil?subreason:@""),(location!=nil?location:@"")];\
	NSLog(@"[ERROR] %@",message);\
	if ([NSThread isMainThread]==NO) {\
		@throw [NSException exceptionWithName:exceptionName reason:message userInfo:nil];\
...
enum {
	UItableViewTestNativeItemNone = -1, 
	UItableViewTestNativeItemSpinner = -2,
	UItableViewTestNativeItemProgressBar = -3,
	
	UItableViewTestNativeItemSlider = -4,
	UItableViewTestNativeItemSwitch = -5,
	UItableViewTestNativeItemMultiButton = -6,
	UItableViewTestNativeItemSegmented = -7,
	
	UItableViewTestNativeItemTextView = -8,
	UItableViewTestNativeItemTextField = -9,
	UItableViewTestNativeItemSearchBar = -10,
	
	UItableViewTestNativeItemPicker = -11,
	UItableViewTestNativeItemDatePicker = -12,
	
	UItableViewTestNativeItemInfoLight = -13,
	UItableViewTestNativeItemInfoDark = -14,
	
	UItableViewTestNativeItemDisclosure = -15,
	
	UItableViewTestNativeItemContactAdd = -16
};
