...
//@interface tableViewTestObject : NSObject
//@end

@interface tableViewTestObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[tableViewTestObject class]])
		{
			for (NSString *key in [[(tableViewTestObject*)o modules] allKeys])
			{
